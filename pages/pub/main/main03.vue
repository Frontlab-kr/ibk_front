      ...
      <div class="ibk-main-my">
        ...
        <div class="ibk-main-my-tabs">
          <Tabs value="1">
            ...
            <TabPanels>
              <TabPanel value="0">
                <div class="ibk-main-my-skill" id="ibkMainSwiper00">
                  <div class="ibk-main-my-skill-button">
                    <div class="ibk-main-my-skill-button__prev">
                      <Button icon="ibk-icon-24-skill-prev" text rounded />
                    </div>
                    <div class="ibk-main-my-skill-button__next">
                      <Button icon="ibk-icon-24-skill-next" text rounded />
                    </div>
                  </div>
                  ...
                  <div class="ibk-main-my-skill-state">
                    <Swiper
                      ...
                      :loop="true"
                      :navigation="{
                        nextEl: '#ibkMainSwiper00 .ibk-icon-24-skill-next',
                        prevEl: '#ibkMainSwiper00 .ibk-icon-24-skill-prev',
                      }"
                    >
                      <SwiperSlide v-for="slide in 3" :key="slide">
                        <div class="ibk-main-my-skill-score">
                          <div class="ibk-main-my-skill-score__text">
                            <div class="ibk-main-my-skill-score__text-item">
                              <span>Level 1</span>
                        ...
                        <div class="ibk-main-my-skill-slide">
                          <div class="mo">
                          ...
                          <hr />
                          <div class="mo">
                            <h4><i class="ibk-icon-24-medal"></i>Level 2</h4>
                          </div>
                          <dl>
                            <dt class="checked">
                              <span class="text-primary">이수완료</span>
                          ...
                          <hr />
                          <div class="mo">
                            <h4><i class="ibk-icon-24-medal"></i>Level 3</h4>
                          </div>
                          <dl>
                            <dt>
                              <span class="text-primary">이수완료</span>
                ...
                <div class="ibk-main-my-hrd">
                  ...
                  <div class="ibk-main-my-hrd-state">
                    <div class="ibk-main-my-hrd-state-section">
                      ...
                      <dl>
                        <dt class="small checked">
                          <span class="text-primary">이수완료</span>
                        </dt>
                        <dd>
                          <div class="ibk-main-my-hrd-state-item small checked">
                            <strong>필수</strong>
                            <p>4/4 이수</p>
                          </div>
                          <div class="ibk-main-my-hrd-state-item small">
                            <strong>선택</strong>
                            <p>2/4 이수</p>
                          </div>
                        </dd>
                    ...
                    <div class="ibk-main-my-hrd-state-section">
                      ...
                      <dl>
                        ...
                        <dd>
                          <div class="ibk-main-my-hrd-state-item small none">
                            <strong>행내평정</strong>
                            <p>4.7/5</p>
                          </div>
                          <div class="ibk-main-my-hrd-state-item small none">
                    ...
                    <div class="ibk-main-my-hrd-state-section ibk-main-my-hrd-state-section--grid">
                      ...
                      <dl>
                        <dd>
                          <div class="ibk-main-my-hrd-state-item small none active">
                            <strong>행내평균</strong>
                            <p>97</p>
                          </div>
                          <div class="ibk-main-my-hrd-state-item small none">
