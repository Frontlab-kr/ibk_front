...
declare global {
  ...
  const $clone: typeof import('../../utils/$clone')['default']
  const $confirm: typeof import('../../utils/$confirm')['default']
  const $formatFileSize: typeof import('../../utils/$formatFileSize')['default']
  const $fromDateToStr: typeof import('../../utils/$fromDateToStr')['default']
  const $isEmpty: typeof import('../../utils/$isEmpty')['default']
  const $isLoading: typeof import('../../utils/$isLoading')['default']
  const $isLocal: typeof import('../../utils/$isLocal')['default']
  const $item: typeof import('../../utils/$item')['default']
  const $itemWithPaging: typeof import('../../utils/$itemWithPaging')['default']
  const $request: typeof import('../../utils/$request')['default']
  const $required: typeof import('../../utils/$required')['default']
  const $response: typeof import('../../utils/$response')['default']
  const $stringDateFormat: typeof import('../../utils/$stringDateFormat')['default']
  const $toDate: typeof import('../../utils/$toDate')['default']
  const $validate: typeof import('../../utils/$validate')['default']
  const $vt: typeof import('../../utils/$vt')['default']
  const $wrap: typeof import('../../utils/$wrap')['default']
  ...
  const formatDateRange: typeof import('../../utils/$dateUtils')['formatDateRange']
  const formatEndDate: typeof import('../../utils/$dateUtils')['formatEndDate']
  const generateId: typeof import('../../utils/generateId')['generateId']
  ...
  const useAnimationOpenClose: typeof import('../../composables/animationOpenClose')['useAnimationOpenClose']
  ...
  const useCompLearning: typeof import('../../composables/compLearning')['useCompLearning']
  ...
  const useText: typeof import('../../composables/text')['useText']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly $alert: UnwrapRef<typeof import('../../utils/$alert')['default']>
    readonly $api: UnwrapRef<typeof import('../../utils/$api')['default']>
    readonly $clone: UnwrapRef<typeof import('../../utils/$clone')['default']>
    readonly $confirm: UnwrapRef<typeof import('../../utils/$confirm')['default']>
    readonly $formatFileSize: UnwrapRef<typeof import('../../utils/$formatFileSize')['default']>
    readonly $fromDateToStr: UnwrapRef<typeof import('../../utils/$fromDateToStr')['default']>
    readonly $isEmpty: UnwrapRef<typeof import('../../utils/$isEmpty')['default']>
    readonly $isLoading: UnwrapRef<typeof import('../../utils/$isLoading')['default']>
    readonly $isLocal: UnwrapRef<typeof import('../../utils/$isLocal')['default']>
    readonly $item: UnwrapRef<typeof import('../../utils/$item')['default']>
    readonly $itemWithPaging: UnwrapRef<typeof import('../../utils/$itemWithPaging')['default']>
    readonly $request: UnwrapRef<typeof import('../../utils/$request')['default']>
    readonly $required: UnwrapRef<typeof import('../../utils/$required')['default']>
    readonly $response: UnwrapRef<typeof import('../../utils/$response')['default']>
    readonly $stringDateFormat: UnwrapRef<typeof import('../../utils/$stringDateFormat')['default']>
    readonly $toDate: UnwrapRef<typeof import('../../utils/$toDate')['default']>
    readonly $validate: UnwrapRef<typeof import('../../utils/$validate')['default']>
    readonly $vt: UnwrapRef<typeof import('../../utils/$vt')['default']>
    readonly $wrap: UnwrapRef<typeof import('../../utils/$wrap')['default']>
    ...
    readonly formatDateRange: UnwrapRef<typeof import('../../utils/$dateUtils')['formatDateRange']>
    readonly formatEndDate: UnwrapRef<typeof import('../../utils/$dateUtils')['formatEndDate']>
    readonly generateId: UnwrapRef<typeof import('../../utils/generateId')['generateId']>
    ...
    readonly useAnimationOpenClose: UnwrapRef<typeof import('../../composables/animationOpenClose')['useAnimationOpenClose']>
    ...
    readonly useCompLearning: UnwrapRef<typeof import('../../composables/compLearning')['useCompLearning']>
    ...
    readonly useText: UnwrapRef<typeof import('../../composables/text')['useText']>
