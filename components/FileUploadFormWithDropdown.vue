<template>
  <div class="card">
    ...
    <FileUpload name="demo[]" :multiple="props.multiple" :accept="props.accept" :maxFileSize="props.maxFileSize"
      @select="onSelectedFiles" :file-limit="props.fileLimit">
      <template #header="{ chooseCallback, uploadCallback, clearCallback, files }">
        <div class="flex flex-wrap justify-content-between align-items-center flex-1 gap-4">
          <div class="flex gap-2">
            ...
            ></Button>
            -->
            <Button @click="onClearTemplatingUpload(clearCallback)" icon="bi bi-x" rounded outlined severity="danger"
          ...
          <div v-if="files.length > 0">
            ...
            <div class="flex flex-wrap gap-4">
              <div v-for="(file, index) of files" :key="file.name + file.type + file.size"
                ...
                <div>
                  <img v-if="isImageFile(file)" role="presentation" :alt="file.name" :src="file.objectURL" width="100"
                    height="50" />
                ...
                <Button icon="bi bi-x" @click="onRemoveTemplatingFile(file, removeFileCallback, index)" outlined rounded
                  severity="warn" />
              </div>
            </div>
          </div>
      ...
      <template #empty>
        <div class="flex align-items-center justify-content-center flex-column">
          <div class="flex align-items-center justify-content-center border-1 border-circle border-400"
...
const onClearTemplatingUpload = (clearCallback: Function) => {
  clearCallback();
  totalSize.value = 0;
